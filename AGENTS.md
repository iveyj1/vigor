...
**Minimal ex commands.** vi has dozens of ex commands. vigor supports only: new, edit, write, quit, wq, qa, next, prev, ls, k/bdelete, set, substitute, read, bang, make, qf, rg, and rgf. Abbreviations (`:e`, `:w`, `:q`, `:r`, `:n`, `:p`, `:k`) work.
